...
namespace SocialApp.Server.Migrations
{
    ...
    [Migration("20230809094253_CreateReservations")]
            ...
            modelBuilder.Entity("SocialApp.Shared.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 8, 9, 9, 42, 53, 482, DateTimeKind.Utc).AddTicks(573),
                            Deleted = false,
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 8, 9, 9, 42, 53, 482, DateTimeKind.Utc).AddTicks(576),
                            Deleted = false,
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2023, 8, 9, 9, 42, 53, 482, DateTimeKind.Utc).AddTicks(577),
                            Deleted = false,
                        ...
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2023, 8, 9, 9, 42, 53, 482, DateTimeKind.Utc).AddTicks(578),
                            Deleted = false,
                        ...
                        {
                            Id = 5,
                            CreatedDate = new DateTime(2023, 8, 9, 9, 42, 53, 482, DateTimeKind.Utc).AddTicks(579),
                            Deleted = false,
                        ...
                        {
                            Id = 6,
                            CreatedDate = new DateTime(2023, 8, 9, 9, 42, 53, 482, DateTimeKind.Utc).AddTicks(580),
                            Deleted = false,
            ...
            modelBuilder.Entity("SocialApp.Shared.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 8, 9, 9, 42, 53, 481, DateTimeKind.Utc).AddTicks(9873),
                            Email = "larsson.christoffer@gmail.com",
                            LastActive = new DateTime(2023, 8, 9, 9, 42, 53, 481, DateTimeKind.Utc).AddTicks(9873),
                            Name = "Christoffer Larsson",
                            PasswordHash = new byte[] { 18, 11, 103, 112, 201, 113, 110, 206, 133, 130, 153, 229, 59, 210, 147, 52, 88, 244, 82, 162, 50, 252, 192, 117, 225, 88, 203, 203, 112, 84, 179, 167, 142, 106, 108, 44, 92, 37, 124, 194, 2, 43, 8, 53, 201, 167, 232, 202, 89, 46, 32, 65, 36, 33, 49, 188, 137, 245, 120, 132, 28, 2, 208, 143 },
                            PasswordSalt = new byte[] { 126, 39, 145, 208, 155, 221, 253, 117, 139, 190, 235, 12, 90, 222, 199, 70, 107, 83, 55, 220, 169, 211, 19, 163, 179, 223, 232, 165, 161, 15, 0, 68, 16, 139, 244, 244, 240, 14, 146, 81, 226, 233, 42, 6, 34, 238, 102, 2, 150, 161, 30, 32, 124, 6, 47, 179, 212, 3, 158, 17, 7, 214, 57, 115, 131, 153, 229, 88, 182, 102, 183, 146, 5, 138, 99, 114, 4, 197, 39, 165, 142, 218, 182, 30, 161, 158, 109, 173, 108, 7, 156, 89, 223, 48, 244, 22, 107, 70, 94, 122, 81, 93, 103, 184, 227, 22, 171, 249, 228, 24, 87, 151, 131, 205, 212, 92, 153, 227, 124, 246, 156, 255, 253, 238, 212, 32, 235, 104 },
                            Role = "Admin"
                        });
                });
