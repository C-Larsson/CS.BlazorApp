...
namespace SocialApp.Server.Migrations
{
    ...
    [Migration("20230821111522_ChangeInProfile")]
    partial class ChangeInProfile
    {
            ...
            modelBuilder.Entity("SocialApp.Shared.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 8, 21, 11, 15, 21, 517, DateTimeKind.Utc).AddTicks(6106),
                            Deleted = false,
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 8, 21, 11, 15, 21, 517, DateTimeKind.Utc).AddTicks(6109),
                            Deleted = false,
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2023, 8, 21, 11, 15, 21, 517, DateTimeKind.Utc).AddTicks(6111),
                            Deleted = false,
                        ...
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2023, 8, 21, 11, 15, 21, 517, DateTimeKind.Utc).AddTicks(6112),
                            Deleted = false,
                        ...
                        {
                            Id = 5,
                            CreatedDate = new DateTime(2023, 8, 21, 11, 15, 21, 517, DateTimeKind.Utc).AddTicks(6114),
                            Deleted = false,
                        ...
                        {
                            Id = 6,
                            CreatedDate = new DateTime(2023, 8, 21, 11, 15, 21, 517, DateTimeKind.Utc).AddTicks(6116),
                            Deleted = false,
            ...
            modelBuilder.Entity("SocialApp.Shared.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 8, 21, 11, 15, 21, 517, DateTimeKind.Utc).AddTicks(5094),
                            Email = "larsson.christoffer@gmail.com",
                            LastActive = new DateTime(2023, 8, 21, 11, 15, 21, 517, DateTimeKind.Utc).AddTicks(5096),
                            Name = "Christoffer Larsson",
                            PasswordHash = new byte[] { 133, 124, 178, 108, 89, 68, 132, 207, 47, 243, 217, 101, 212, 183, 3, 48, 50, 120, 235, 45, 88, 99, 26, 218, 1, 221, 189, 73, 16, 2, 32, 123, 123, 67, 148, 53, 252, 82, 108, 7, 41, 35, 121, 186, 156, 5, 192, 139, 63, 6, 128, 57, 204, 49, 191, 90, 151, 20, 18, 207, 41, 138, 80, 58 },
                            PasswordSalt = new byte[] { 42, 220, 13, 148, 153, 255, 205, 104, 195, 247, 188, 233, 100, 62, 11, 119, 75, 224, 78, 161, 158, 2, 206, 177, 114, 245, 188, 81, 122, 57, 239, 237, 49, 123, 83, 117, 253, 25, 157, 179, 137, 198, 178, 41, 123, 10, 185, 66, 147, 119, 125, 166, 192, 96, 232, 210, 242, 241, 225, 247, 30, 149, 152, 97, 133, 72, 60, 151, 193, 40, 22, 23, 215, 11, 182, 185, 40, 203, 105, 68, 168, 51, 57, 160, 115, 230, 98, 254, 196, 72, 232, 114, 16, 67, 13, 172, 35, 199, 25, 70, 77, 254, 25, 139, 75, 255, 232, 131, 99, 1, 230, 33, 103, 150, 209, 143, 126, 182, 129, 252, 204, 247, 212, 143, 78, 227, 234, 89 },
                            Role = "Admin"
                        });
                });
