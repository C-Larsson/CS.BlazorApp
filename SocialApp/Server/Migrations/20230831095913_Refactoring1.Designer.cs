...
namespace SocialApp.Server.Migrations
{
    ...
    [Migration("20230831095913_Refactoring1")]
            ...
            modelBuilder.Entity("SocialApp.Shared.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 8, 31, 9, 59, 12, 103, DateTimeKind.Utc).AddTicks(4791),
                            Deleted = false,
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 8, 31, 9, 59, 12, 103, DateTimeKind.Utc).AddTicks(4795),
                            Deleted = false,
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2023, 8, 31, 9, 59, 12, 103, DateTimeKind.Utc).AddTicks(4797),
                            Deleted = false,
                        ...
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2023, 8, 31, 9, 59, 12, 103, DateTimeKind.Utc).AddTicks(4798),
                            Deleted = false,
                        ...
                        {
                            Id = 5,
                            CreatedDate = new DateTime(2023, 8, 31, 9, 59, 12, 103, DateTimeKind.Utc).AddTicks(4800),
                            Deleted = false,
                        ...
                        {
                            Id = 6,
                            CreatedDate = new DateTime(2023, 8, 31, 9, 59, 12, 103, DateTimeKind.Utc).AddTicks(4801),
                            Deleted = false,
            ...
            modelBuilder.Entity("SocialApp.Shared.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Blocked = false,
                            CreatedDate = new DateTime(2023, 8, 31, 9, 59, 12, 103, DateTimeKind.Utc).AddTicks(3778),
                            Deleted = false,
                            Email = "larsson.christoffer@gmail.com",
                            LastActive = new DateTime(2023, 8, 31, 9, 59, 12, 103, DateTimeKind.Utc).AddTicks(3780),
                            Name = "Christoffer Larsson",
                            PasswordHash = new byte[] { 70, 77, 43, 191, 1, 88, 86, 11, 150, 254, 207, 86, 180, 75, 99, 145, 88, 245, 111, 28, 232, 133, 222, 217, 174, 141, 142, 116, 184, 129, 146, 241, 248, 42, 23, 224, 211, 1, 110, 247, 168, 114, 113, 97, 110, 212, 60, 47, 139, 142, 30, 171, 127, 66, 6, 37, 5, 91, 9, 170, 90, 87, 246, 185 },
                            PasswordSalt = new byte[] { 162, 233, 31, 36, 144, 12, 240, 147, 57, 230, 72, 66, 171, 111, 183, 244, 245, 5, 0, 63, 216, 81, 147, 14, 68, 87, 46, 119, 224, 99, 64, 123, 237, 68, 110, 254, 177, 164, 130, 129, 56, 56, 165, 22, 112, 107, 238, 114, 239, 7, 183, 191, 45, 84, 246, 176, 37, 8, 220, 153, 189, 114, 155, 100, 193, 247, 232, 78, 216, 157, 120, 10, 206, 80, 244, 134, 1, 43, 108, 56, 68, 11, 232, 36, 124, 200, 2, 179, 251, 88, 197, 192, 143, 66, 19, 67, 162, 194, 249, 124, 239, 241, 55, 164, 255, 139, 251, 228, 143, 244, 66, 130, 108, 78, 21, 22, 209, 125, 203, 134, 168, 205, 118, 53, 211, 6, 36, 138 },
                            Role = "Admin"
                        });
                });
