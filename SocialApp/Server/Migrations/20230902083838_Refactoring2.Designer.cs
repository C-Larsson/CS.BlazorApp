...
namespace SocialApp.Server.Migrations
{
    ...
    [Migration("20230902083838_Refactoring2")]
            ...
            modelBuilder.Entity("SocialApp.Shared.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 9, 2, 8, 38, 37, 707, DateTimeKind.Utc).AddTicks(4935),
                            Deleted = false,
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 9, 2, 8, 38, 37, 707, DateTimeKind.Utc).AddTicks(4939),
                            Deleted = false,
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2023, 9, 2, 8, 38, 37, 707, DateTimeKind.Utc).AddTicks(4940),
                            Deleted = false,
                        ...
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2023, 9, 2, 8, 38, 37, 707, DateTimeKind.Utc).AddTicks(4942),
                            Deleted = false,
                        ...
                        {
                            Id = 5,
                            CreatedDate = new DateTime(2023, 9, 2, 8, 38, 37, 707, DateTimeKind.Utc).AddTicks(4943),
                            Deleted = false,
                        ...
                        {
                            Id = 6,
                            CreatedDate = new DateTime(2023, 9, 2, 8, 38, 37, 707, DateTimeKind.Utc).AddTicks(4945),
                            Deleted = false,
            ...
            modelBuilder.Entity("SocialApp.Shared.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Blocked = false,
                            CreatedDate = new DateTime(2023, 9, 2, 8, 38, 37, 707, DateTimeKind.Utc).AddTicks(3542),
                            Deleted = false,
                            Email = "larsson.christoffer@gmail.com",
                            LastActive = new DateTime(2023, 9, 2, 8, 38, 37, 707, DateTimeKind.Utc).AddTicks(3546),
                            Name = "Christoffer Larsson",
                            PasswordHash = new byte[] { 152, 20, 210, 210, 61, 44, 125, 22, 206, 226, 203, 201, 10, 169, 180, 203, 164, 8, 244, 34, 207, 6, 182, 88, 41, 7, 103, 176, 137, 25, 20, 41, 26, 193, 43, 181, 153, 48, 88, 28, 88, 244, 231, 124, 42, 103, 94, 118, 218, 226, 28, 46, 199, 75, 210, 57, 222, 83, 66, 110, 251, 75, 82, 48 },
                            PasswordSalt = new byte[] { 156, 29, 108, 186, 1, 153, 229, 217, 25, 34, 120, 97, 64, 197, 216, 139, 200, 202, 120, 232, 252, 165, 113, 42, 24, 87, 6, 250, 130, 243, 78, 160, 47, 185, 10, 31, 231, 67, 200, 135, 164, 16, 95, 199, 221, 245, 110, 186, 142, 6, 61, 60, 246, 39, 14, 121, 255, 12, 105, 20, 65, 206, 238, 249, 110, 88, 14, 62, 237, 210, 86, 152, 74, 24, 62, 32, 248, 166, 71, 130, 108, 219, 55, 154, 228, 101, 87, 177, 240, 92, 32, 170, 89, 199, 16, 151, 103, 21, 225, 136, 67, 48, 252, 35, 74, 204, 53, 158, 22, 207, 233, 65, 126, 196, 170, 180, 249, 39, 216, 177, 224, 216, 105, 182, 225, 205, 17, 129 },
                            Role = "Admin"
                        });
                });
