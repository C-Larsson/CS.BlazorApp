...
namespace SocialApp.Server.Migrations
{
    ...
    [Migration("20230808044924_SetEventImageUrlNullable")]
    partial class SetEventImageUrlNullable
    {
            ...
            modelBuilder.Entity("SocialApp.Shared.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 8, 8, 4, 49, 24, 5, DateTimeKind.Utc).AddTicks(4645),
                            Deleted = false,
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 8, 8, 4, 49, 24, 5, DateTimeKind.Utc).AddTicks(4650),
                            Deleted = false,
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2023, 8, 8, 4, 49, 24, 5, DateTimeKind.Utc).AddTicks(4651),
                            Deleted = false,
                        ...
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2023, 8, 8, 4, 49, 24, 5, DateTimeKind.Utc).AddTicks(4653),
                            Deleted = false,
                        ...
                        {
                            Id = 5,
                            CreatedDate = new DateTime(2023, 8, 8, 4, 49, 24, 5, DateTimeKind.Utc).AddTicks(4655),
                            Deleted = false,
                        ...
                        {
                            Id = 6,
                            CreatedDate = new DateTime(2023, 8, 8, 4, 49, 24, 5, DateTimeKind.Utc).AddTicks(4656),
                            Deleted = false,
            ...
            modelBuilder.Entity("SocialApp.Shared.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 8, 8, 4, 49, 24, 5, DateTimeKind.Utc).AddTicks(3632),
                            Email = "larsson.christoffer@gmail.com",
                            LastActive = new DateTime(2023, 8, 8, 4, 49, 24, 5, DateTimeKind.Utc).AddTicks(3636),
                            Name = "Christoffer Larsson",
                            PasswordHash = new byte[] { 99, 8, 181, 3, 44, 1, 121, 161, 39, 250, 28, 123, 83, 158, 55, 138, 142, 24, 148, 80, 88, 19, 137, 216, 153, 217, 218, 90, 107, 199, 41, 238, 169, 148, 118, 139, 46, 220, 248, 92, 51, 232, 112, 108, 107, 186, 90, 71, 178, 116, 75, 153, 201, 244, 1, 177, 45, 131, 111, 144, 70, 212, 164, 137 },
                            PasswordSalt = new byte[] { 1, 166, 144, 234, 37, 102, 91, 208, 113, 47, 112, 95, 242, 75, 23, 196, 222, 54, 70, 215, 21, 208, 194, 30, 102, 200, 153, 25, 251, 16, 13, 185, 27, 121, 121, 216, 243, 81, 170, 211, 238, 225, 46, 237, 233, 24, 75, 119, 87, 223, 119, 127, 169, 80, 173, 106, 118, 34, 67, 68, 38, 67, 153, 190, 235, 144, 102, 51, 229, 43, 5, 72, 59, 222, 104, 18, 225, 227, 55, 93, 163, 74, 241, 219, 153, 184, 170, 133, 100, 197, 185, 115, 225, 214, 159, 170, 63, 244, 41, 212, 239, 98, 209, 116, 32, 177, 18, 209, 44, 222, 213, 242, 185, 250, 21, 118, 86, 184, 198, 32, 9, 142, 92, 178, 129, 143, 246, 68 },
                            Role = "Admin"
                        });
                });
