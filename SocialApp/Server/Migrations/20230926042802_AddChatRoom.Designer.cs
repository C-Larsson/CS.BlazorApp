...
namespace SocialApp.Server.Migrations
{
    ...
    [Migration("20230926042802_AddChatRoom")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialApp.Shared.Models.Tables.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 9, 26, 4, 28, 1, 690, DateTimeKind.Utc).AddTicks(8785),
                            Deleted = false,
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 9, 26, 4, 28, 1, 690, DateTimeKind.Utc).AddTicks(8789),
                            Deleted = false,
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2023, 9, 26, 4, 28, 1, 690, DateTimeKind.Utc).AddTicks(8790),
                            Deleted = false,
                        ...
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2023, 9, 26, 4, 28, 1, 690, DateTimeKind.Utc).AddTicks(8792),
                            Deleted = false,
                        ...
                        {
                            Id = 5,
                            CreatedDate = new DateTime(2023, 9, 26, 4, 28, 1, 690, DateTimeKind.Utc).AddTicks(8794),
                            Deleted = false,
                        ...
                        {
                            Id = 6,
                            CreatedDate = new DateTime(2023, 9, 26, 4, 28, 1, 690, DateTimeKind.Utc).AddTicks(8796),
                            Deleted = false,
            ...
            modelBuilder.Entity("SocialApp.Shared.Models.Tables.ChatRoom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SocialApp.Shared.Models.Tables.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Blocked = false,
                            CreatedDate = new DateTime(2023, 9, 26, 4, 28, 1, 690, DateTimeKind.Utc).AddTicks(7796),
                            Deleted = false,
                            Email = "larsson.christoffer@gmail.com",
                            LastActive = new DateTime(2023, 9, 26, 4, 28, 1, 690, DateTimeKind.Utc).AddTicks(7798),
                            Name = "Christoffer Larsson",
                            PasswordHash = new byte[] { 173, 191, 195, 168, 254, 233, 118, 140, 28, 142, 65, 173, 182, 220, 3, 159, 179, 206, 96, 51, 78, 62, 183, 145, 187, 56, 34, 185, 203, 69, 222, 16, 202, 65, 68, 21, 224, 139, 229, 108, 142, 97, 109, 113, 161, 176, 135, 3, 147, 19, 40, 125, 245, 40, 149, 247, 59, 137, 255, 179, 69, 168, 201, 161 },
                            PasswordSalt = new byte[] { 227, 126, 27, 26, 78, 128, 8, 148, 35, 49, 241, 39, 83, 200, 119, 219, 110, 210, 55, 253, 156, 66, 50, 213, 130, 43, 223, 134, 207, 172, 74, 185, 26, 176, 246, 233, 41, 179, 163, 188, 235, 2, 114, 207, 153, 182, 8, 47, 157, 122, 214, 167, 93, 205, 26, 125, 236, 250, 167, 216, 225, 35, 182, 88, 83, 110, 176, 126, 183, 121, 250, 221, 155, 162, 69, 22, 102, 202, 54, 5, 89, 212, 148, 238, 105, 62, 1, 236, 204, 59, 52, 138, 247, 138, 157, 185, 211, 98, 76, 82, 171, 240, 45, 135, 9, 167, 3, 253, 239, 7, 198, 12, 209, 252, 199, 225, 103, 134, 99, 203, 237, 68, 206, 31, 168, 188, 211, 166 },
                            RefreshToken = "",
                            Role = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("SocialApp.Shared.Models.Tables.EventMessage", b =>
                {
                    b.HasOne("SocialApp.Shared.Models.Tables.ChatRoom", "ChatRoom")
                        .WithMany("Messages")
